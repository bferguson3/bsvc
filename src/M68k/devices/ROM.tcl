...
#
# This Tcl script gets the setup information for the ROM device.
#
...
proc DeviceSetup {} {
  ...
  toplevel .device
  wm title .device "ROM Setup"
  wm iconname .device "ROM Setup"

  message .device.message \
    -text "Please enter the base address and size of the ROM.\n\nAll values are in hexadecimal!" \
